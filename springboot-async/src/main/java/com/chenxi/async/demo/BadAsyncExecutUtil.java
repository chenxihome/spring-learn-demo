...
import com.chenxi.async.demo.service.SelfThreadFactory;
...
@Component
@Slf4j
public class BadAsyncExecutUtil {
    ...
    public static List<String> execute(List<CallableTask> tasks) {
        ...
        //返回数据结果集
        ExecutorService exs = Executors.newFixedThreadPool(10,new SelfThreadFactory());
        try {
            //futureList监控结果集
